...
| [plant-death-system.md](plant-death-system.md) | 植物死亡/腐烂系统设计与实现 | 理解植物如何死亡和腐烂 |
...
| [refactoring-plan.md](refactoring-plan.md) | 架构重构计划（2026-06-16审查） | 了解技术债务和重构方向 |
...
详见 [todolist.md](todolist.md)（开发任务清单）和 [refactoring-plan.md](refactoring-plan.md)（架构重构计划）。
