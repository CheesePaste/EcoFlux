...
- `tree/GrowthPlacement` — Record: a block placed during tree growth tagged with animation type (ANIM_TRUNK=0, ANIM_LEAF_INFLATE=1, ANIM_LEAF_CLUSTER=2)
